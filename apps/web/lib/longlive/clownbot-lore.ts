 ...
 * private individuals. Deliberately excluded during authoring: a widely
 * aggregated "spotted boarding a jet in <state> amid bachelorette rumors"
 * item (travel + private-life, banned outright) and an unsourced "erased
 * writing in the promo says June 13" theory (no named outlet — so it does not
 * ship, however good the clowning would have been).
 *
