...
/**
 * `EraId` and the other content-derived id unions below (`TrackKey`,
 ...
 */
import type { EraId, TrackKey, SongSlug, TheoryId, VideoId } from './content-ids.generated';
export type { EraId, TrackKey, SongSlug, TheoryId, VideoId };
