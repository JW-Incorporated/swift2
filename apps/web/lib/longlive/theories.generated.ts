...
export const THEORIES_RAW: Partial<Record<EraId, TheoryNote[]>> = {
  "1989": [
    {
      ...
      kind: "theory",
      title: "\"no it's becky\"",
      claim: "The 2014 Tumblr joke: a photo of Taylor captioned as a girl named Becky who \"died of marijuana overdose,\" answered with \"no it's becky.\" Fans ran with Becky as Taylor's alter ego — and Taylor got the joke.",
      ...
      outcome: "confirmed",
      sources: [{ name: "Becky", url: "https://knowyourmeme.com/memes/becky" }, { name: "Swifties", url: "https://en.wikipedia.org/wiki/Swifties" }],
    },
  ],
  "debut": [
    {
    ...
    },
    {
      ...
      evidence: "A confirmed, deliberate practice — the booklet codes ran from the 2006 debut through the Big Machine albums and trained the fandom to decode everything that followed. She later said the clue-planting simply moved from liner notes into videos, posts, and performances.",
      confidence: "official",
      outcome: "confirmed",
  ...
  "evermore": [
    {
      ...
      claim: "evermore arrived two days before her 31st birthday — and she said the timing was the point: 31 is 13 backwards, so the surprise album marked \"the most aligned\" birthday she could give fans.",
  ...
  "midnights": [
    ...
    },
    {
      ...
      evidence: "Taylor said on release day that the video was stuffed with easter eggs; the fandom filed the purple/third-floor cluster under Speak Now within hours. Eight months later the Nashville announcement proved the read. The clean template of clue -> consensus -> confirmation.",
      confidence: "strong_fan_consensus",
      outcome: "confirmed",
  ...
  "speak-now": [
    ...
    },
    {
      ...
      evidence: "The reveal followed the same re-record playbook used for Fearless and Red (Taylor's Version): a single, fan-facing announcement post naming every vault track and its guest, rather than a label press cycle — by this point a recognizable, repeatable promo format for the re-recording project.",
      confidence: "official",
      outcome: "confirmed",
