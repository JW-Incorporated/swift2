...
export const TRACKS_RAW: Partial<Record<EraId, TrackNote[]>> = {
  ...
  "ttpd": [
    ...
    },
    {
      ...
      discussionSources: [{ name: "So High School — Wikipedia", url: "https://en.wikipedia.org/wiki/So_High_School" }, { name: "The Tortured Poets Department — Wikipedia", url: "https://en.wikipedia.org/wiki/The_Tortured_Poets_Department" }],
    },
    {
      trackNumber: 23,
