...
export const TRACKS_RAW: Partial<Record<EraId, TrackNote[]>> = {
  ...
  "midnights": [
    {
      ...
      writers: ["Taylor Swift", "Jack Antonoff", "Zoë Kravitz", "Sounwave", "Jahaan Sweet", "Sam Dew"],
  ...
  "reputation": [
    ...
    },
    {
      ...
      writers: ["Taylor Swift", "Jack Antonoff", "Richard Fairbrass", "Fred Fairbrass", "Rob Manzoli"],
      producers: ["Taylor Swift", "Jack Antonoff"],
      release: "reputation",
      releaseDate: "2017-11-10",
