...
export const VIDEOS_RAW: Partial<Record<EraId, VideoNote[]>> = {
  ...
  "lover": [
    ...
    },
    {
      ...
      summary: "A live SNL performance of \"False God,\" one of two Lover-album songs Taylor performed on the show the same night.",
      easterEggs: [],
      symbolism: null,
      youtubeId: "kjD3LoXp-Pw",
      sources: [{ name: "Taylor Swift - \"False God\" (Live on Saturday Night Live / 2019)", url: "https://www.youtube.com/watch?v=kjD3LoXp-Pw", reliability: 5, type: "official" }],
      tags: ["Music"],
    },
    {
      ...
      releasedOn: "2019-10-07",
      relatedSongs: ["Lover"],
      summary: "A live SNL performance of the title track \"Lover,\" released the same night as her \"False God\" performance on the show.",
      easterEggs: [],
      symbolism: null,
      youtubeId: "dmipFjOtMA8",
      sources: [{ name: "Taylor Swift - \"Lover\" (Live on Saturday Night Live / 2019)", url: "https://www.youtube.com/watch?v=dmipFjOtMA8", reliability: 5, type: "official" }, { name: "Lover (Taylor Swift song)", url: "https://en.wikipedia.org/wiki/Lover_(Taylor_Swift_song)", reliability: 2, type: "wiki" }],
      tags: ["Music"],
    },
    {
    ...
    },
    {
      ...
      summary: "A live performance of \"The Man\" filmed in Paris during the Lover-era promotional run.",
      easterEggs: [],
      symbolism: null,
      youtubeId: "F3aXpa1rQEY",
      sources: [{ name: "Taylor Swift - The Man (Live From Paris)", url: "https://www.youtube.com/watch?v=F3aXpa1rQEY", reliability: 5, type: "official" }, { name: "The Man (Taylor Swift song)", url: "https://en.wikipedia.org/wiki/The_Man_(Taylor_Swift_song)", reliability: 2, type: "wiki" }],
      tags: ["Music"],
    },
    {
      slug: "the-man-mv",
  ...
  "reputation": [
    ...
    },
    {
      ...
      relatedSongs: ["ME!"],
      summary: "A live performance of \"ME!\" with Brendon Urie on the U.S. broadcast of The Voice.",
      easterEggs: [],
      symbolism: null,
      youtubeId: "_zUCMfYkgj0",
      sources: [{ name: "Taylor Swift - ME! (Live on The Voice / 2019) ft. Brendon Urie", url: "https://www.youtube.com/watch?v=_zUCMfYkgj0", reliability: 5, type: "official" }, { name: "ME!", url: "https://en.wikipedia.org/wiki/Me!", reliability: 2, type: "wiki" }],
      tags: ["Music"],
    },
    {
      ...
      relatedSongs: ["ME!"],
      summary: "A UK television performance of \"ME!\" on The Graham Norton Show during the song's promotional run.",
      easterEggs: [],
      symbolism: null,
      youtubeId: "MA0HQG9J9Yk",
      sources: [{ name: "Taylor Swift - ME! (Live on The Graham Norton Show)", url: "https://www.youtube.com/watch?v=MA0HQG9J9Yk", reliability: 5, type: "official" }, { name: "ME!", url: "https://en.wikipedia.org/wiki/Me!", reliability: 2, type: "wiki" }],
      tags: ["Music"],
    },
    {
