...
export const VIDEOS_RAW: Partial<Record<EraId, VideoNote[]>> = {
  ...
  "tloas": [
    ...
    },
    {
      ...
      summary: "A 1990s-styled rom-com in which Swift's lonely Pet Rock owner and Domhnall Gleeson's cactus owner are brought together by a magical \"Opalite\" spray — released as the era's second single.",
      easterEggs: [],
      symbolism: null,
