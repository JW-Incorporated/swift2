...
export const VIDEOS_RAW: Partial<Record<EraId, VideoNote[]>> = {
  ...
  "midnights": [
    ...
    },
    {
      ...
      relatedSongs: [],
      summary: "Time's editor-in-chief reveals the 2023 Person of the Year live on TODAY — the first person ever named for work in arts and entertainment.",
      easterEggs: [],
      symbolism: null,
      youtubeId: "VeFzmqp6OaQ",
      sources: [{ name: "Taylor Swift named Time’s 2023 Person of the Year", url: "https://www.youtube.com/watch?v=VeFzmqp6OaQ", reliability: 5, type: "official" }],
    },
    {
