...
// This suite exercises the real, app-wired catalogue — see
// apps/web/lib/longlive/threads.ts for the equivalent wiring of
// setThreadContentProvider. packages/experience/src/mood-match.test.ts
// covers the matcher's pure behaviour against synthetic fixtures.
