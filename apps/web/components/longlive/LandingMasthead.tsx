  ...
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      <button
        ...
        className="era-btn-ghost mt-1 inline-flex min-h-14 items-center gap-1.5 rounded-full px-4 text-xs sm:text-sm font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--era-accent)] whitespace-nowrap"
      >
