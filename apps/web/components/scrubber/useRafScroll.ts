 ...
 * rAF per frame — plus once on mount and on resize/layout. This is how the
 * scrubber follows scroll: it reads the scroll position here and writes CSS
 * transforms directly, so nothing re-renders React per pointer-move or per
