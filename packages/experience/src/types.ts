 ...
 * data files, making `types.ts` — imported by every consumer of this package —
 * transitively depend on the entire ~20k-line content corpus. This is the
 * ONLY generated file `types.ts` imports; it never imports the data files
 * directly.
 *
