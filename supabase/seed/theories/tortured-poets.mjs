...
export default {
  ...
  theories: [
    ...
    },
    {
      ...
      evidence:
        'The lineage is right there in the text — the song names Clara Bow (the silent era\'s original "It Girl," who retired young under relentless media scrutiny) and Stevie Nicks by name before turning the same appraising label-speak on Taylor herself. And the reading is not just critical inference: Taylor narrated the song\'s core mechanism herself, describing it as a conversation between "the young woman sitting in the chair in front of the desk, and the man in power or woman in power sitting behind the desk saying, \'Oh, you remind me so much of a woman who came before you, but don\'t worry, you\'re better.\'" That is the assembly line stated by its author — each new "It Girl" told she is the upgrade, which is also the promise that she in turn will be replaced. Critics had already framed it that way (Rolling Stone\'s Rob Sheffield tied it to her earlier fame parables "The Lucky One" and "Nothing New"; NPR and The Ringer to the cyclical nature of stardom), and her own explanation confirms the mechanism rather than merely the imagery. What remains fan shorthand is only the phrase "assembly line," not the dynamic it names.',
      confidence: 'confirmed_interview',
      outcome: 'confirmed',
      relatedSlugs: [],
      sources: [
        {
          source_url: 'https://variety.com/2024/music/news/taylor-swift-tortured-poets-department-meaning-fortnight-clara-bow-florida-1235977904/',
