...
export default {
  ...
  theories: [
    ...
    },
    {
      ...
      claim:
        'On Thursday, Aug 20, 2026 the Empire State Building glowed green and its official X account posted a photo of it captioned "WhaTS happening?" — the capitalized "TS" reading as Taylor\'s initials. The same day, a bright green "TS" logo turned up painted on a black wall at an undisclosed spot, with more of the emblem reported across several cities. Swifties read the green convergence as an easter-egg cue for her next era.',
      evidence:
