...
export default {
  ...
  videos: [
    ...
    // ── "Live From Paris" — City of Lover concert clips (catalog pass
    // 2026-08-25, issue #3286). Filmed at the Trianon in Paris Sept 9, 2019,
    // aired as "Taylor Swift: City of Lover Concert" on ABC/Disney+ May 17,
    // 2020; the full special itself has no official upload ('city-of-lover'
    // above, hidden per playable-first). These six song clips share the same
    // May 17, 2020 YouTube release; Cornelia Street was held back and posted
    // separately on June 22, 2020 (see below). A second Cornelia Street
    // upload (id 3xGvCApIEQY, same title) exists but could not be confirmed
    // as a genuinely distinct performance — skipped as a likely duplicate.
    {
      slug: 'the-archer-live-from-paris',
      kind: 'performance',
      title: 'Taylor Swift - The Archer (Live From Paris)',
      director: null,
      releasedOn: '2020-05-17',
      relatedSongs: ['The Archer'],
      tags: ['Music'],
      summary: 'A solo acoustic "The Archer" from the City of Lover concert special, filmed at the Trianon in Paris.',
      symbolism: null,
      easterEggs: [],
      officialUrl: 'https://www.youtube.com/watch?v=d_2WyBcFbFY',
      media: [embed('d_2WyBcFbFY')],
      sources: [
        yt('d_2WyBcFbFY', 'Taylor Swift - The Archer (Live From Paris)'),
        wiki('Taylor_Swift:_City_of_Lover_Concert', 'Taylor Swift: City of Lover Concert', 'anchors the Sept 2019 filming and May 2020 broadcast/YouTube release'),
      ],
    },
    {
      slug: 'daylight-live-from-paris',
      kind: 'performance',
      title: 'Taylor Swift - Daylight (Live From Paris)',
      director: null,
      releasedOn: '2020-05-17',
      relatedSongs: ['Daylight'],
      tags: ['Music'],
      summary: 'A live "Daylight" from the City of Lover concert special, filmed at the Trianon in Paris.',
      symbolism: null,
      easterEggs: [],
      officialUrl: 'https://www.youtube.com/watch?v=JSD4XCBWzvs',
      media: [embed('JSD4XCBWzvs')],
      sources: [
    ...
    {
      slug: 'you-need-to-calm-down-live-from-paris',
      kind: 'performance',
      title: 'Taylor Swift - You Need To Calm Down (Live From Paris)',
      director: null,
      releasedOn: '2020-05-17',
      relatedSongs: ['You Need to Calm Down'],
      tags: ['Music'],
      summary: 'A live "You Need To Calm Down" from the City of Lover concert special, filmed at the Trianon in Paris.',
      symbolism: null,
      easterEggs: [],
      officialUrl: 'https://www.youtube.com/watch?v=Uxg-ivPGusQ',
      media: [embed('Uxg-ivPGusQ')],
      sources: [
    ...
    {
      slug: 'me-live-from-paris',
      kind: 'performance',
      title: 'Taylor Swift - ME! (Live From Paris)',
      director: null,
      releasedOn: '2020-05-17',
      relatedSongs: ['ME!'],
      tags: ['Music'],
      summary: 'A live "ME!" from the City of Lover concert special, filmed at the Trianon in Paris.',
      symbolism: null,
      easterEggs: [],
      officialUrl: 'https://www.youtube.com/watch?v=DIMDgq_MYJs',
      media: [embed('DIMDgq_MYJs')],
      sources: [
    ...
    },
    {
      ...
      relatedSongs: ['Lover'],
      tags: ['Music'],
      summary: 'A live "Lover" from the City of Lover concert special, filmed at the Trianon in Paris.',
      symbolism: null,
      easterEggs: [],
      officialUrl: 'https://www.youtube.com/watch?v=a4iTHPwioEc',
      media: [embed('a4iTHPwioEc')],
      sources: [
    ...
    {
      slug: 'death-by-a-thousand-cuts-live-from-paris',
      kind: 'performance',
      title: 'Taylor Swift - Death By A Thousand Cuts (Live From Paris)',
      director: null,
      releasedOn: '2020-05-17',
      relatedSongs: ['Death By A Thousand Cuts'],
      tags: ['Music'],
      summary: 'A live "Death By A Thousand Cuts" from the City of Lover concert special, filmed at the Trianon in Paris.',
      symbolism: null,
      easterEggs: [],
      officialUrl: 'https://www.youtube.com/watch?v=rqsmrSyLTNM',
      media: [embed('rqsmrSyLTNM')],
      sources: [
    ...
    },
    {
      ...
      director: null,
      releasedOn: '2020-06-22',
      relatedSongs: ['Cornelia Street'],
      tags: ['Music'],
      summary:
        'A live "Cornelia Street" from the City of Lover concert special, posted about five weeks after the other Paris clips as a standalone surprise release.',
      symbolism: null,
      easterEggs: [],
      officialUrl: 'https://www.youtube.com/watch?v=Vgt1d3eAm7A',
      media: [embed('Vgt1d3eAm7A')],
      sources: [
        yt('Vgt1d3eAm7A', 'Taylor Swift - Cornelia Street (Live From Paris)'),
        press(
          'https://www.udiscovermusic.com/news/taylor-swift-cornelia-street-city-of-lover/',
          "Watch Taylor Swift's Live Performance Of 'Cornelia Street'",
          'uDiscoverMusic',
          'supports the June 22, 2020 standalone release date, separate from the May 17 batch',
        ),
      ],
    },
