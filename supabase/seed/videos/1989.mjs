...
export default {
  ...
  videos: [
    ...
    },
    {
      ...
      // Apple Music REMOVED this title 2020-05-22 with no announced return
      // and no other official release (#3476 follow-up research,
      // 2026-09-10) — unlike most of the records this card unlocks, there is
