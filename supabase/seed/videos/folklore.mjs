...
export default {
  ...
  videos: [
    ...
    {
      // Catalog pass 2026-08-25 (issue #3286).
      ...
      tags: ['Music'],
      summary:
        'A black-and-white studio performance of "exile" with Bon Iver\'s Justin Vernon, from the Disney+ special "folklore: the long pond studio sessions."',
      symbolism: null,
      easterEggs: [],
      officialUrl: 'https://www.youtube.com/watch?v=o5SQIECedTY',
      media: [
        {
          kind: 'oembed',
          rights: 'platform_tos',
          provider: 'youtube',
          post_url: 'https://www.youtube.com/watch?v=o5SQIECedTY',
          oembed_fetched_at: '2026-08-25',
          attribution: 'Taylor Swift — official YouTube channel',
        },
      ],
      sources: [
        {
          source_url: 'https://www.youtube.com/watch?v=o5SQIECedTY',
          source_title: 'Taylor Swift - exile (folklore: the long pond studio sessions | Disney+) ft. Bon Iver',
          publisher: 'Taylor Swift (official YouTube channel)',
          source_type: 'official',
          accessed_at: '2026-08-25',
          reliability_score: 5,
        ...
        wiki('Folklore:_The_Long_Pond_Studio_Sessions', 'Folklore: The Long Pond Studio Sessions', 'confirms the Nov 25, 2020 Disney+ premiere'),
      ],
    },
    {
      ...
      tags: ['Music'],
      summary:
        'A Vevo Footnotes making-of episode on the "cardigan" video\'s piano-portal effects, released a few weeks after the song itself.',
      symbolism: null,
      easterEggs: [],
      officialUrl: 'https://www.youtube.com/watch?v=GPQdWYNi8Wc',
      media: [
        {
          kind: 'oembed',
          rights: 'platform_tos',
          provider: 'youtube',
          post_url: 'https://www.youtube.com/watch?v=GPQdWYNi8Wc',
          oembed_fetched_at: '2026-08-25',
          attribution: 'Taylor Swift — official YouTube channel',
        },
      ],
      sources: [
        {
          source_url: 'https://www.youtube.com/watch?v=GPQdWYNi8Wc',
          source_title: "Taylor Swift - The Making of 'cardigan' | Vevo Footnotes",
          publisher: 'Taylor Swift (official YouTube channel)',
          source_type: 'official',
          accessed_at: '2026-08-25',
          reliability_score: 5,
        ...
        wiki('Cardigan_(song)', 'cardigan (song)', 'anchors the July 24, 2020 video this making-of episode documents'),
      ],
    },
  ],
};
