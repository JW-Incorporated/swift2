...
const TRACKS = [
    ...
    },
    {
      ...
      dossier: {
        ...
        meaning: {
          ...
          fanTheories: [
            "Fans often read \"Fifteen\" as the quiet thesis of Fearless — that the album's louder fairy tales (\"Love Story,\" the title track) are what a fifteen-year-old wants, while this song is the older narrator gently telling her there is more to want than a boy's attention."
          ]
        },
        connections: [
          {
            ...
            label: "The Best Day",
            why: "The album's other unguarded autobiography — \"The Best Day\" for her mother, \"Fifteen\" for her best friend; the two songs where Fearless drops the fairy tale and names the real people in Swift's life."
          },
          {
            relatedId: "song:you-belong-with-me",
            label: "You Belong With Me",
            why: "Two views of the same high-school world — the wry outsider fantasy of \"You Belong With Me\" and the tender, clear-eyed hindsight of \"Fifteen.\""
          },
          {
            relatedId: "song:white-horse",
            label: "White Horse",
            why: "Both trade the era's romance for its comedown — \"Fifteen\" warning a younger girl what's coming, \"White Horse\" living through it."
          }
        ],
        sources: [
          {
            name: "Fifteen (song) — Wikipedia",
            url: "https://en.wikipedia.org/wiki/Fifteen_(song)",
            reliability_score: 2
          },
          {
            name: "Fifteen by Taylor Swift — Songfacts",
            url: "https://www.songfacts.com/facts/taylor-swift/fifteen",
            reliability_score: 3
          }
        ]
      },
    },
    {
      ...
      dossier: {
        whyItMatters: [
          "The song that turned a country teenager into a global pop star. Swift has said she wrote it alone on her bedroom floor in about 20 minutes, reaching for the most famous forbidden-love story she knew — Romeo and Juliet — and overruling Shakespeare to hand the couple the happy ending the play denies them. Released as Fearless's lead single on Sept. 15, 2008, it became the album's calling card and the template for the fairy-tale-with-a-rewrite that would define her early writing.",
          "It was a genuine crossover event, not just a country hit: it peaked at No. 4 on the Billboard Hot 100, became the first country song ever to reach No. 1 on Billboard's Pop Songs (Mainstream Top 40) airplay chart, and is certified 8× platinum by the RIAA. Thirteen years later its re-recording became a landmark of a different kind — the first song of the entire Taylor's Version project and proof the strategy could top the charts on its own."
        ],
        meaning: {
          confirmed: [
            "Written solo by Swift and produced by Nathan Chapman and Swift; she has said it started with a boy her family disapproved of and that she wrote it in roughly 20 minutes on her bedroom floor, recasting the romance through Romeo and Juliet but replacing the tragic ending with a proposal.",
            "Released Sept. 15, 2008 as the lead single from Fearless on Big Machine Records; it debuted at No. 25 on Hot Country Songs — her highest debut on that chart at the time — and reached No. 1 there in November 2008, her third country No. 1.",
            "It peaked at No. 4 on the Billboard Hot 100 and became the first country song to top Billboard's Pop Songs airplay chart, and the RIAA has since certified it 8× platinum.",
            "\"Love Story (Taylor's Version)\" was released Feb. 12, 2021 as the first single from her re-recording campaign; it debuted at No. 1 on Hot Country Songs (her first song to debut at the summit there) and at No. 11 on the Hot 100, making Swift the second artist after Dolly Parton to top Hot Country Songs with both an original and its re-recording."
          ],
          supported: [
            "The single's success is widely credited as the moment Swift's audience expanded decisively beyond country radio into mainstream pop, setting up the album-of-the-year run that followed.",
            "Its Renaissance-costume period video became one of her most-recognized early visuals and a recurring reference point in her later fairy-tale imagery."
          ],
          fanTheories: [
            "Because Swift has framed the song as a fantasy built on a disapproved-of crush rather than a documented romance, fans generally read \"Love Story\" as an idealized rewrite — she takes a real feeling of being told no and imagines the version where the story is allowed to end happily."
          ]
        },
        connections: [
          {
            relatedId: "song:you-belong-with-me",
            label: "You Belong With Me",
            why: "The two blockbuster singles that carried Fearless's country-to-pop crossover — \"Love Story\" the fairy-tale fantasy, \"You Belong With Me\" the girl-next-door underdog, together the era's commercial engine."
          },
          {
            relatedId: "song:white-horse",
            label: "White Horse",
            why: "The morning-after rebuttal to this song's fantasy: where \"Love Story\" rewrites the ending happy, \"White Horse\" admits the fairy tale was a lie — the album arguing with itself about romance."
          },
          {
            relatedId: "song:fearless",
            label: "Fearless",
            why: "The album's two definitive fairy-tale statements — the title track turns a first date into a leap of faith, \"Love Story\" turns a tragedy into a proposal."
          }
        ],
        sources: [
          {
            name: "Love Story (Taylor Swift song) — Wikipedia",
            url: "https://en.wikipedia.org/wiki/Love_Story_(Taylor_Swift_song)",
            reliability_score: 2
          },
          {
            name: "Taylor Swift's 'Love Story (Taylor's Version)' Debuts at No. 1 on Hot Country Songs — Billboard",
            url: "https://www.billboard.com/pro/taylor-swift-love-story-number-one-hot-country-songs/",
            reliability_score: 4
          }
        ]
      },
    ...
    },
    {
      ...
      dossier: {
        whyItMatters: [
          "Fearless's biggest pure-pop moment and, at the time, the highest-charting song of Swift's career: it peaked at No. 2 on the Billboard Hot 100. Co-written with Liz Rose, it takes the oldest teen-movie setup — the girl next door versus the cheer captain — and makes the whole song her closing argument for why she's the easier person to love. Swift has said it was sparked by overhearing a male friend on a tense, defensive phone call with his girlfriend.",
          "Its Roman White-directed video — in which Swift plays both the bespectacled band geek and the popular brunette — won Best Female Video at the 2009 MTV VMAs, and that acceptance speech became one of the most-replayed moments in award-show history when Kanye West took the microphone to say Beyoncé \"had one of the best videos of all time.\" The interruption seeded a public storyline that Swift would still be working through eras later."
        ],
        meaning: {
          confirmed: [
            "Written by Swift and Liz Rose and produced by Nathan Chapman and Swift; Swift has said the idea came from overhearing a male friend placating his girlfriend on the phone, which she spun into the perspective of the girl who would be easier to love.",
            "Released as the third single from Fearless, it peaked at No. 2 on the Billboard Hot 100 — her highest position at that point — reached No. 1 on Hot Country Songs, and is certified 7× platinum by the RIAA.",
            "The music video, directed by Roman White, casts Swift as both leads — the sympathetic blonde girl-next-door and the unsympathetic brunette cheer captain — and won Best Female Video at the 2009 MTV Video Music Awards on Sept. 13, 2009.",
            "During Swift's VMA acceptance speech, Kanye West walked on stage, took the microphone, and said Beyoncé \"had one of the best videos of all time\"; the song was also nominated for Record of the Year, Song of the Year, and Best Female Pop Vocal Performance at the 2010 Grammys."
          ],
          supported: [
        ...
        connections: [
          {
            relatedId: "song:love-story",
            label: "Love Story",
            why: "The album's other blockbuster single; together they carried Fearless's country-to-pop crossover and made Swift a mainstream star."
          },
          {
            relatedId: "song:fifteen",
            label: "Fifteen",
            why: "Two sides of the same high-school world — \"Fifteen\" the tender coming-of-age memory, \"You Belong With Me\" the bleachers-and-cheer-captain fantasy of being finally seen."
          },
          {
            relatedId: "song:white-horse",
            label: "White Horse",
            why: "The disillusioned counterweight to this song's hopeful pining — both watch a romance from the outside, one still hoping, one already let down."
          }
        ],
        sources: [
          {
            name: "You Belong with Me — Wikipedia",
            url: "https://en.wikipedia.org/wiki/You_Belong_with_Me",
            reliability_score: 2
          },
          {
            name: "2009 MTV VMAs Oral History: Kanye West Interrupts Taylor Swift's Moment — Billboard",
            url: "https://www.billboard.com/culture/tv-film/2009-mtv-vmas-oral-history-8523549/",
            reliability_score: 4
          }
        ]
      },
