...
const TRACKS = [
    ...
    },
    {
      ...
      summary:
        'Everyone wants the story of the ending, including the two people it happened to, who genuinely do not know — grief with a Greek chorus of rubberneckers. It is track 21 — the fifth of the fifteen “Anthology” bonus songs that surprise-dropped at 2 a.m. ET on release night (that second half opens with “The Black Dog,” track 17) — and it reached No. 35 on the Billboard Hot 100 during TTPD’s record-setting chart week, just outside the top 14 the album monopolized. Swift debuted it live as a solo piano ballad at the final Stockholm Eras Tour show (May 19, 2024) and played it only once more, in a “You’re Losing Me” mashup in Toronto (Nov. 23, 2024); Variety later ranked it 11th among her best songs and The Independent named it one of 2024’s best.',
      inspiration:
