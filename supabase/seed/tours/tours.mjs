    ...
    },
    {
      ...
      shows: [
        ...
        },
        {
          ...
          confidence: 'reputable_reporting',
          sources: [
            wiki('Speak_Now_(Taylor%27s_Version)', "Speak Now (Taylor's Version)", 'announcement documented to the 2023-05-05 Nashville show'),
            press(
        ...
        },
        {
          ...
          confidence: 'reputable_reporting',
          sources: [
            wiki('1989_(Taylor%27s_Version)', "1989 (Taylor's Version)", 'announcement documented to the 2023-08-09 SoFi show'),
            press(
        ...
        },
        {
          ...
          confidence: 'reputable_reporting',
          sources: [
            wiki('The_Eras_Tour', 'The Eras Tour', 'the Buenos Aires lyric change is documented in the tour article'),
            press(
        ...
        },
        {
          ...
          confidence: 'reputable_reporting',
          sources: [
            wiki('The_Eras_Tour', 'The Eras Tour', 'the Wembley cameo is documented in the tour article'),
            press(
