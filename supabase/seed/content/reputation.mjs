      ...
      moment: {
        ...
        rumors: [
          ...
          },
          {
            ...
            note: 'The lyric edits are documented; the re-record tease is the unconfirmed read. Re-checked 2026-08-17: still no announced reputation re-record or Vault release, but the question stays actively covered (Billboard was still asking in 2026), so this is STILL LIVE, not faded — one live topic with the two entries above. Resolves on an announced re-record or Vault release; no location.',
            sourceTier: 'established',
