...
export default {
  ...
  items: [
    ...
    },
    {
      ...
      thumbnailUrl: 'https://58v76y8z87lo.hellomagazine.com/horizon/original_aspect_ratio/d02f741a61d4-taylor-a.jpg',
      moment: {
        sources: [
          {
            outlet: 'Refinery29',
        ...
        photos: [{ url: 'https://58v76y8z87lo.hellomagazine.com/horizon/original_aspect_ratio/d02f741a61d4-taylor-a.jpg', credit: 'Getty Images' }],
      },
    },
    ...
    },
    {
      ...
      moment: {
        context:
          'Swift later confirmed the real timeline herself, in a diary entry included with a Lover deluxe edition, dated Jan. 3, 2017: "We have been together and no one has found out for 3 months now."',
        sources: [
          {
            outlet: 'Today',
    ...
    // checked for a 2xx image response before being added.
    {
      ...
      moment: {
        context:
          'The Ashish set arrived the same month "Bad Blood" won Video of the Year. Swift walked the red carpet flanked by Martha Hunt, Hailee Steinfeld, Cara Delevingne, Selena Gomez, Serayah, Lily Aldridge, Gigi Hadid, and Karlie Kloss — the "squad" era in its full, coordinated force.',
        sources: [
          {
    ...
    },
    {
      ...
      moment: {
        context:
          'The two-tone, two-piece look bared her midriff on the same red carpet where she\'d go on to make history as the first woman to win Album of the Year twice.',
        sources: [
          {
            outlet: 'E! Online',
    ...
    },
    {
      ...
      moment: {
        context:
          "E! Online's red-carpet coverage that night singled out the new haircut alongside the outfit as the story of her look — a bob-with-bangs silhouette she'd keep returning to in the years after.",
        sources: [
          {
            outlet: 'E! Online',
            url: 'https://www.eonline.com/news/740307/taylor-swift-s-grammys-2016-red-carpet-outfit-looks-very-familiar-and-this-is-why',
    ...
    },
    {
      ...
      moment: {
        context:
          'One of a long run of paparazzi-caught New York street style looks E! Online has tracked over the years — mixing casual denim, sneakers, and minimal styling with the much more constructed red-carpet image from the same period.',
        sources: [
