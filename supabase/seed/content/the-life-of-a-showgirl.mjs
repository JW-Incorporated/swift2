...
export default {
  ...
  items: [
    ...
    // --- Vault Run 2026-08-08, Content Shift lane. Three verified wedding-arc
    // and music color items from the intake queue (#1844, #1842, #1841). Each
    // right-sized to a sub-detail card (media/text tier, modest body) so none
    // displaces a hero slot; every URL and quote independently re-fetched and
    // read this session.
    {
      ...
      moment: {
        ...
        sources: [
          ...
          },
          {
            ...
            source_title: "Charles Barkley declined Travis Kelce, Taylor Swift wedding invitation for a simple reason",
            publisher: 'Fox News',
            source_type: 'reputable_press',
            accessed_at: '2026-08-08',
            reliability_score: 3,
        ...
        // photographed event, so this is the closest true visual (same pattern
        // as the Maren item). thumbnailUrl set to this url so the sync makes it
        // the primary image. upload.wikimedia.org (allowlisted); curl 200 +
        // image/jpeg, 979x1305, downloaded and vision-confirmed as Charles
        // Barkley (bald, gray pinstripe suit, striped tie). Public domain.
        photos: [
          {
            url: 'https://upload.wikimedia.org/wikipedia/commons/3/3c/Charles_Barkley_in_2026.jpg',
            credit: 'Daniel Peterson / U.S. Air Force (public domain), Wikimedia Commons',
            caption: 'Charles Barkley, March 2026.',
            kind: 'archival',
            focalPoint: '52% 28%',
          },
        ],
      ...
      moment: {
        ...
        sources: [
          ...
          },
          {
            ...
            source_title: 'Kylie Kelce reacts to Jason\'s comments about crying at Travis and Taylor\'s wedding',
            publisher: 'TODAY',
            source_type: 'reputable_press',
            accessed_at: '2026-08-08',
            reliability_score: 4,
          ...
          {
            outlet: 'AOL',
            url: 'https://www.aol.com/articles/kylie-kelce-clarifies-why-jason-145306000.html',
            source_title: 'Kylie Kelce clarifies why Jason cried at Travis and Taylor\'s wedding',
            publisher: 'AOL',
            source_type: 'reputable_press',
            accessed_at: '2026-08-08',
            reliability_score: 3,
        ...
        // curl 200 + image/jpeg, 655x944, downloaded and vision-confirmed as
        // Jason Kelce (bearded, white NFL compression shirt, on a field).
        photos: [
          {
            url: 'https://upload.wikimedia.org/wikipedia/commons/6/60/JasonKelce.jpg',
            credit: 'Joe Glorioso / All-Pro Reels, Wikimedia Commons, CC BY-SA 2.0',
            caption: 'Jason Kelce, September 2022.',
            kind: 'archival',
            focalPoint: '50% 24%',
          },
        ],
    ...
    {
      slug: 'showgirl-august-pulled-from-trump-tiktok',
      year: 2026,
      month: 8,
      day: 7,
      category: 'music',
      relatedIds: [],
      title: '"August" goes silent on a Team Trump TikTok',
      snippet:
        'A "Team Trump" TikTok that set Taylor\'s "August" to footage of the president watching fireworks lost its audio within days, replaced by a copyright-block notice. The removal is confirmed; who triggered it — Taylor, her team, or an automated process — is not.',
      sourceUrl: 'https://www.thewrap.com/creative-content/music/taylor-swift-removes-august-audio-trump-tiktok/',
      thumbnailUrl: null,
      moment: {
        context:
          'In early August 2026, a TikTok on Donald Trump\'s "Team Trump" account set footage of the president and first lady watching fireworks to Taylor\'s 2020 Folklore track "August," captioned, "I\'m sure @Taylor Swift is going to be super excited we used her song!" By that Friday evening the sound was gone: in the U.S. app the clip now reads, "The copyright owner hasn\'t made this sound available in your country."\n\nThat the audio was pulled is documented and corroborated across outlets. Who pulled it, and why, is not. Headlines split between "Swift blocks Trump" and the more careful "appears to," and Variety noted that representatives for both Taylor and Trump declined to comment — leaving open whether she or her team personally filed the complaint or an automated rights process did. Because Taylor owns her masters and publishing, she has more leverage than most artists to restrict a use like this; leverage is not the same as a confirmed act, so the "who" stays in the rumor column until a named party says so.',
        // Handling note (intake #1841): framed as a music/copyright event, not a
        // political take. The removal is authored as confirmed fact; the
        // "Swift blocked him" attribution sits in the rumor container only, per
        // the privacy/rumor rules. No location/security/health redline. Left
        // deliberately photo-less (text tier) — this is a copyright-nuance
        // item, not a photographed event.
        sources: [
          {
            outlet: 'TheWrap',
            url: 'https://www.thewrap.com/creative-content/music/taylor-swift-removes-august-audio-trump-tiktok/',
            source_title: 'Taylor Swift Appears to Block Trump From Using Her Song in TikTok Celebrating His Presidency',
            publisher: 'TheWrap',
            source_type: 'reputable_press',
            accessed_at: '2026-08-08',
            reliability_score: 3,
          },
          {
            ...
            source_title: "Taylor Swift Removes Song 'August' From Trump TikTok Video",
            publisher: 'Variety',
            source_type: 'reputable_press',
            accessed_at: '2026-08-08',
            reliability_score: 4,
          },
          {
            ...
            source_title: 'Team Trump Trolls Taylor Swift With Song Use Before Copyright Claim',
            publisher: 'Deadline',
            source_type: 'reputable_press',
            accessed_at: '2026-08-08',
            reliability_score: 3,
        ...
        rumors: [
          {
            claim:
              'After a "Team Trump" TikTok used Taylor\'s "August," the song\'s audio was removed and replaced with a copyright-block notice; multiple outlets framed it as Taylor "blocking" Trump, though whether she or her team personally filed the complaint was never confirmed.',
            reportedBy: 'Variety / TheWrap',
            reportedOn: '2026-08-07',
            status: 'unconfirmed',
            url: 'https://www.thewrap.com/creative-content/music/taylor-swift-removes-august-audio-trump-tiktok/',
            note: 'The removal itself is confirmed and documented. The attribution is not: TheWrap and Variety both hedged with "appears to," and reps for both Taylor and Trump declined to comment, so it is unknown whether Taylor, her team, or an automated process triggered it. Framed as a music/copyright event, not a political take. No redline.',
            sourceTier: 'established',
            lastCheckedOn: '2026-08-08',
          },
        ],
      },
    },
