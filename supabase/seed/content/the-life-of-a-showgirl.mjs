        ...
        rumors: [
          {
            ...
            note: 'An on-record Dior statement about the reveal mechanism, not the gown itself. Rechecked 2026-08-12: still no official reveal — Taylor has not posted the gown to her own Instagram. Unofficial paparazzi/second-look images have circulated, and bridal brands are prepping "Swift-inspired" lines off the unseen dress, but the official first look the Dior spokesperson described has not appeared. Resolves when official photos surface via her Instagram, as described.',
            sourceTier: 'official',
