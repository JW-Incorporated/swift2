  ...
  items: [
    ...
    },
    {
      ...
      moment: {
        ...
        // permalink the page already cites and ABC News embeds; verified by
        // rendering instagram.com/p/DN02niAXMM-/embed/captioned: the taylorswift
        // verified account, the "getting married" caption. Embedded rather than
        // hotlinked — Instagram CDN urls are signed/expiring and the host is not
        // on the image allowlist.
        socialPost: {
          platform: 'instagram',
          shortcode: 'DN02niAXMM-',
          label:
            'The joint announcement itself: a five-photo garden-proposal carousel captioned "Your English teacher and your gym teacher are getting married 🧨."',
          postedOn: '2025-08-26',
        },
        context:
