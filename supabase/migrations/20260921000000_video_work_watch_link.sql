...
-- records that genuinely have nothing (see content-enrichment/videos.ts's
-- `isWatchable`).
--
-- Both nullable, both optional: a record with neither `youtube_id`-worthy
-- media nor `watch_url` stays hidden exactly as before — this is additive.
