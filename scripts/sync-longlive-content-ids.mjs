#!/usr/bin/env node
// Regenerates packages/experience/src/content-ids.generated.ts — the literal
...
// docs/reviews/2026-09-fable-architecture-review.md §1.3/§3.2). Redone
// against the OS-021 `packages/experience/src` layout (the original R10,
// PR #3728, targeted `apps/web/lib/longlive/` before that relocation).
//
...
const OUT_FILE = path.join(ROOT, 'packages', 'experience', 'src', 'content-ids.generated.ts');
