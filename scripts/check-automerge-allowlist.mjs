 ...
 * repo-relative POSIX path with the reason.
 *
 * OS-014 (2026-09-05): the eight `apps/web/lib/longlive/*.generated.ts` vault
 * modules are no longer committed to git (see .gitignore,
 * docs/longlive-experience.md §9) — they are gitignored, build-time-only
 * output. A content PR can therefore never actually touch these paths in its
 * diff (git ignores them), so they can neither need auto-merge review nor
 * benefit from being on the allowlist; excluded here rather than left in
 * `.github/content-automerge-allowlist.txt` as a dead entry nothing can ever
 * match.
 *
...
export const EXCLUDED = {
  'apps/web/lib/longlive/content-vault.generated.ts':
    'OS-014: no longer committed to git (gitignored, build-time-only) — cannot appear in a PR diff.',
  ...
  'apps/web/lib/longlive/videos.generated.ts':
    'OS-014: no longer committed to git (gitignored, build-time-only) — cannot appear in a PR diff.',
  'apps/web/lib/longlive/era-secrets.generated.ts':
    'OS-014: no longer committed to git (gitignored, build-time-only) — cannot appear in a PR diff.',
  'apps/web/lib/longlive/song-moods.generated.ts':
    'OS-014: no longer committed to git (gitignored, build-time-only) — cannot appear in a PR diff.',
  'apps/web/lib/longlive/clownbot-lore.generated.ts':
    'OS-014: no longer committed to git (gitignored, build-time-only) — cannot appear in a PR diff.',
  'apps/web/lib/longlive/merch.generated.ts':
    'OS-014: no longer committed to git (gitignored, build-time-only) — cannot appear in a PR diff.',
  'apps/web/lib/longlive/theories-bundle.generated.ts':
    'OS-014b-3: generated by scripts/generate-bundle-backed-modules.mjs from the published content bundle — gitignored, build-time-only, cannot appear in a PR diff.',
  'apps/web/lib/longlive/videos-bundle.generated.ts':
    'OS-014b-3: generated by scripts/generate-bundle-backed-modules.mjs from the published content bundle — gitignored, build-time-only, cannot appear in a PR diff.',
};
