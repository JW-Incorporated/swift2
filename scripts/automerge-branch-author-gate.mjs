...
export const CONTENT_LANE_BRANCH_PREFIXES = [
  ...
  'tree/', // docs/agents/runner-prompts/tree-weekly-plan.md + tree-daily-draft.md + docs/agents/tree.md ("branch `tree/<date>`", `tree/draft/<date>`)
  ...
  'social-poster/state-', // docs/social/pipeline.md + docs/decisions.md 2026-08-12 (#2031 ledger PRs)
