...
import * as rumorGap from './checkers/rumor-gap.mjs';
...
const DET_CHECKERS = [numericDate, redlines, imageUrlQuality, photoSparsity, imageOveruse, imageLiveness, imageModeration, depthDeficit, rumorGap];
