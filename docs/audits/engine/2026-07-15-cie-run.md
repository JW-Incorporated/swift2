# Content Integrity Engine — run 2026-07-15

Corpus: 993 items · 571 distinct images (source: supabase/seed/**). Read-only run — findings only, no content changed.

**Totals:** 149 findings — P0 0 · P1 0 · P2 149 · P3 0

> **Filable findings shown below** (confidence ≥ 0.5). A further **426** deterministic claim-risk signals
