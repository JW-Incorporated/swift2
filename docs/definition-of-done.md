...
| 3 | Clue Web vs Decode cards differentiated | 🟡 built, awaiting Joey's eyeball ([#2058](https://github.com/JW-Incorporated/swift2/pull/2058)) | Joey checks the two cards side by side — the last acceptance criterion |
