...
| Era videos | `EraVideos` | inline rail in `EraSection` ("Videos & appearances"); official-upload embeds (via `MomentVideo`) + metadata cards. Two families: works she made, and appearances (interview / award speech / speech / press event) |
