...
Undocumented runner (issue #2258 §3b) — no standalone prompt file existed in this repo before this export (only a Vault Run lane file, `vault-lanes/6-stylist.md`); recovered verbatim from Wyatt's live trigger, 2026-08-22, before disabling.
