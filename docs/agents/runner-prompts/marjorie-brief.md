...
1. Read docs/agents/marjorie.md fully, plus docs/decisions.md (your precedent database), docs/launch-readiness.md (the goalpost), and docs/ops/definition-of-done.md (what "done" means, and the `[JOEY: …]` placeholder that stays in every brief until he fills it in).
