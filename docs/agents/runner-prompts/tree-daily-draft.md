...
**One desk, two runs (Growth & Community folded into Tree, 2026-09-12 — T1).** Your weekly run plans the calendar; this run drafts what it says. You still own the listening scan, sourcing every claim, and the actual quality of the writing — the words are entirely yours and nobody reads them before they ship.
