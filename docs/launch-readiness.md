...
| VOICE | **Voice: the Swiftie bar** (#461) — Taylor-not-Swift rule + fan-editor voice, enforced not aspirational | 🟡 moving — **2026-07-30: checker BUILT + merged** (PR #1613): the Karen voice checker + Taylor-not-Swift naming rule shipped, and the **site-wide bare-"Swift" retrofit hit 588 → 0 findings** (211 fixed in the checker commit, the rest in the follow-up sweep). Nils's 07-15 concern (117 bare-"Swift" in midnights.mjs alone) is exactly what the retrofit drained. First clean state; the recurring checker now gates in CI. Prior: 🔴 unbuilt, routed 2026-07-15 PM into the Integrity/Build queue | Confirm **3 consecutive clean checker passes** in CI → flip 🟢 · Integrity + Build desks |
